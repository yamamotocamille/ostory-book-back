...
class __TwigTemplate_c1ae103067a1020f327a7425e1c02a1c1196f3fdb9e76f387cd0dcd4f10613a9 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"my-5 py-5\">
    ...
    ";
        ...
        echo "        <div class=\"navigation d-flex justify-content-center\">
            ";
        // line 45
        echo $this->extensions['Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationExtension']->render($this->env, (isset($context["users"]) || array_key_exists("users", $context) ? $context["users"] : (function () { throw new RuntimeError('Variable "users" does not exist.', 45, $this->source); })()));
        echo "
        </div>
...
";
    ...
    {
        return array (  166 => 45,  163 => 44,  159 => 42,  154 => 39,  145 => 35,  135 => 30,  131 => 29,  125 => 26,  121 => 25,  117 => 24,  114 => 23,  109 => 22,  94 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "user/index.html.twig", "/var/www/html/Apothéose/07-le-site-dont-vous-etes-le-heros-back/templates/user/index.html.twig");
    }
}

...
/* user/show.html.twig */
class __TwigTemplate_fe310fdfd0efbed4fff3e38a40a43d94a22a5ef63a80c137b04228affd7ef8f6 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table table-hover\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 24
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 24, $this->source); })()), "nickname", [], "any", false, false, false, 24), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
";
    ...
    {
        return array (  132 => 33,  127 => 31,  117 => 24,  110 => 20,  103 => 16,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "user/show.html.twig", "/var/www/html/Apothéose/07-le-site-dont-vous-etes-le-heros-back/templates/user/show.html.twig");
    }
}

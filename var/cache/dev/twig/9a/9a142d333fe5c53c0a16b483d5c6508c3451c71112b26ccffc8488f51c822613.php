...
class __TwigTemplate_9938d3d403e57a2637277b460fcb12bb7ee5a95d2b7f86e03c8143bef6fd16fa extends Template
{
    private $source;
    private $macros = [];
...
{% macro render_bus_messages(messages, showBus = false) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/messenger.html.twig", "/var/www/html/Apothéose/07-le-site-dont-vous-etes-le-heros-back/vendor/symfony/web-profiler-bundle/Resources/views/Collector/messenger.html.twig");
    }
}

...
class __TwigTemplate_76736b635e6b87e263e4f6951cf25274e79f7ce26b2ded6b71f202df6212472a extends Template
{
    private $source;
    private $macros = [];
...
{% block title %}Email de récupération envoyé{% endblock %}
...
<div class=\"my-5 py-5\">
    <div class=\"col-lg-6 mx-auto\">
        ...
        <p>Si vous ne recevez pas d'e-mail, veuillez vérifier votre dossier spam ou <a href=\"{{ path('app_forgot_password_request') }}\">ré-essayez</a>.</p>
    </div>           
</div>
{% endblock %}
", "reset_password/check_email.html.twig", "/var/www/html/Apothéose/07-le-site-dont-vous-etes-le-heros-back/templates/reset_password/check_email.html.twig");
    }
}

...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/back/user'), [0 => 'ROLE_ADMIN'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/back'), [0 => 'ROLE_MANAGER'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/(histoire|user)'), [0 => 'ROLE_USER'], NULL);

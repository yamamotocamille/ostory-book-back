...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService')), ($container->privates['slugger'] ?? ($container->privates['slugger'] = new \Symfony\Component\String\Slugger\AsciiSlugger('fr'))), ($container->privates['App\\Repository\\PageRepository'] ?? $container->load('getPageRepositoryService')), ($container->privates['App\\Repository\\ChoiceRepository'] ?? $container->load('getChoiceRepositoryService')), ($container->privates['App\\Repository\\StoryRepository'] ?? $container->load('getStoryRepositoryService'))), 'groups' => []]]);
